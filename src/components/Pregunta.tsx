...
const Pregunta: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const fetchTests = async () => {
      try {
        const response = await fetch("https://cors-proxy.escolavisionhlanz.workers.dev/leer.php?tabla=tests");
  ...
  const fetchPreguntas = async (testId: number) => {
    try {
      const response = await fetch("https://cors-proxy.escolavisionhlanz.workers.dev/leer.php?tabla=preguntas");
